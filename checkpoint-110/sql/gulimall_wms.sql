...
CREATE TABLE `wms_purchase`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_purchase
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (1, 2, 'leifengyang', '12345678912', 1, 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms_purchase` VALUES (2, 1, 'admin', '13612345678', NULL, 2, NULL, NULL, '2023-10-26 10:22:53', '2023-10-26 10:39:39');
INSERT INTO `wms_purchase` VALUES (3, 1, 'admin', '13612345678', NULL, 3, NULL, NULL, '2023-10-26 11:03:46', '2023-10-26 11:05:12');
...
INSERT INTO `wms_purchase_detail` VALUES (2, 2, 3, 2, NULL, 1, 4);
INSERT INTO `wms_purchase_detail` VALUES (3, 3, 2, 10, NULL, 1, 3);
INSERT INTO `wms_purchase_detail` VALUES (4, 3, 3, 15, NULL, 1, 3);
INSERT INTO `wms_purchase_detail` VALUES (5, 3, 4, 5, NULL, 1, 3);
...
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES (1, 1, 1, 110, '华为', 0);
INSERT INTO `wms_ware_sku` VALUES (2, 2, 1, 10, NULL, 0);
INSERT INTO `wms_ware_sku` VALUES (3, 3, 1, 15, NULL, 0);
INSERT INTO `wms_ware_sku` VALUES (4, 4, 1, 5, NULL, 0);

...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 1, 2, '铜牌会员', 6259.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 1, 3, '银牌会员', 6219.0000, 1);
...
INSERT INTO `sms_member_price` VALUES (9, 5, 2, '铜牌会员', 6259.0000, 1);
INSERT INTO `sms_member_price` VALUES (10, 5, 3, '银牌会员', 6219.0000, 1);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品满减信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 10000.0000, 50.0000, NULL);
...
INSERT INTO `sms_sku_full_reduction` VALUES (5, 5, 10000.0000, 50.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 3, 0.98, NULL, 1);
...
INSERT INTO `sms_sku_ladder` VALUES (5, 5, 3, 0.98, NULL, 1);
...
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1, 2, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 3, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 4, 500.0000, 500.0000, NULL);
